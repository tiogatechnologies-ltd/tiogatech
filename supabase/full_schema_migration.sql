...
-- ==========================================
-- Migration: 20260923120000_add_mw_real_life_blog_post.sql
-- ==========================================

INSERT INTO public.blog_posts (
  slug, title, excerpt, content, cover_image_url, author, tags, category, published, published_at, seo_title, seo_description, read_minutes
)
VALUES (
  'how-strong-is-1-mw-in-real-life',
  'How “Strong” is 1 MW in Real Life? (MW vs MWh, Homes Powered & Commercial Solar Explained)',
  'What does 1 megawatt (1 MW) actually mean in everyday life? Discover how many homes, appliances, or factories 1 MW can power, the difference between MW and MWh, and what it means for solar & battery storage.',
  $$When people hear the word **megawatt (MW)**, they usually know it represents a massive amount of electrical power. But what does **1 MW** actually look like in everyday life? How many homes or appliances can it run at once? How many solar panels does it take to produce 1 MW? And why do electrical engineers always distinguish between **MW** and **MWh**?
...
$$,
  'https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=1600&q=80&auto=format&fit=crop',
  'Tioga Engineering Team',
  ARRAY['1 MW in real life', 'MW vs MWh', 'commercial solar nigeria', 'megawatt explanation', 'battery energy storage', 'solar engineering'],
  'Solar Engineering',
  true,
  '2026-09-23T12:00:00.000Z',
  'How “Strong” is 1 MW in Real Life? MW vs MWh & Real-World Scale',
  'Learn what 1 MW of power looks like in real life: how many homes it powers, how to convert MW to kW, the difference between MW and MWh, and how 1 MW solar & battery systems work.',
  8
)
