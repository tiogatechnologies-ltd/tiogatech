            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap items-center gap-2.5 pt-2">
                  <Link
                    to="/packages"
                    className="inline-flex items-center gap-1.5 rounded-full bg-accent/90 hover:bg-accent backdrop-blur-xl border border-accent/40 px-4 py-2 text-xs font-semibold text-accent-foreground hover:brightness-110 shadow-sm transition-all"
                  >
                    <Package size={14} />
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-1.5 rounded-full bg-secondary-foreground/10 hover:bg-secondary-foreground/20 backdrop-blur-xl border border-secondary-foreground/20 px-4 py-2 text-xs font-semibold text-secondary-foreground transition-all"
                  >
                    <Cpu size={14} />
                    Calculate Sizing
                  </Link>
