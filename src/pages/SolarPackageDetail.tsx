            ...
            <div className="lg:col-span-6 lg:sticky lg:top-28 space-y-4">
              <div className="relative rounded-3xl overflow-hidden bg-card border border-border shadow-[var(--shadow-card)] aspect-[4/3]">
                ...
                <div className="absolute top-4 left-4 flex flex-col gap-2">
                  <span className="text-[11px] font-bold bg-gold text-midnight px-3 py-1 rounded-full shadow">
                    #{pkg.package_number}
                  </span>
                  ...
                  {pkg.badge && (
                    <span className="text-[11px] font-bold bg-primary text-primary-foreground px-3 py-1 rounded-full shadow">
                      {pkg.badge}
                    </span>
                  )}
                </div>
                ...
                <div className="absolute bottom-0 inset-x-0 p-5">
                  <p className="text-[11px] uppercase tracking-widest text-white/70 mb-1">{batteryLabel} System</p>
                  <h1 className="text-xl sm:text-2xl font-display font-bold text-white leading-tight">{pkg.inverter}</h1>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3">
                {[
                  { icon: ShieldCheck, label: "5-Year Warranty", sub: "Inverter & Panels" },
                  { icon: Wrench, label: "Pro Install", sub: "Within 48–72h" },
                  { icon: Clock, label: "Support", sub: "Mon–Sat, 8am–6pm" },
