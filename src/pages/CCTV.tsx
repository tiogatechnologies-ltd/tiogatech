            ...
            {packages.map((pkg, idx) => (
              ...
              >
                <div className="relative h-52 overflow-hidden">
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-5 bg-midnight/55 backdrop-blur-xl backdrop-saturate-150 border-t border-white/20 shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.25)]">
