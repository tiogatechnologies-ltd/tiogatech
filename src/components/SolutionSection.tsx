    ...
    <section className="py-16 bg-secondary text-secondary-foreground">
      <div ref={ref} className={`section-container text-center max-w-3xl ${isVisible ? "animate-slide-up" : "opacity-0"}`}>
        ...
        <p className="text-secondary-foreground/70 text-lg leading-relaxed">
          Tioga combines solar energy, intelligent home automation, and modern security into a seamless experience. No more juggling multiple vendors or dealing with unreliable systems. We design, install, and support everything — so you can focus on what matters most.
        </p>
      </div>
    </section>
  );
