...
import bgSolarField from "@/assets/bg-panel-closeup.jpg";
import bgLagosNight from "@/assets/bg-lagos-day.jpg";
import bgTechMesh from "@/assets/bg-hex.jpg";
import bgTeam from "@/assets/bg-installer.jpg";
