...
export const STOCK_PACKAGE_IMAGES: StockPackageImage[] = [
  ...
  { label: "Elite K209 3D Face ID Smart Lock", category: "lock", url: "/products/core/stama-k209-face-lock.webp" },
  { label: "Elite S7 Israeli Edition Lock", category: "lock", url: "/products/core/stama-s7-premier.webp" },
  { label: "Apex D20 Biometric Smart Lock", category: "lock", url: "/products/core/stama-d20-apex.webp" },
  { label: "Apex H11 Video Doorbell Lock", category: "lock", url: "/products/core/stama-h11-intercom.webp" },
  { label: "Apex F27 Wi-Fi Video Intercom Lock", category: "lock", url: "/products/core/stama-f27-wifi.webp" },
  { label: "Apex T8 Israeli Custom Lock", category: "lock", url: "/products/core/stama-t8-israeli.webp" },
  { label: "Pro SL02 Aluminum Slim Lock", category: "lock", url: "/products/core/stama-sl02-aluminum.webp" },
  { label: "Pro N14 Time-Attendance Smart Lock", category: "lock", url: "/products/core/stama-n14-pro.webp" },
  { label: "Pro N22 Security Smart Lock", category: "lock", url: "/products/core/stama-n22-security.webp" },
  { label: "Pro X04 Best-Value Smart Lock", category: "lock", url: "/products/core/stama-x04-budget.webp" },
  { label: "Basic-Pro B16 Camera Smart Lock", category: "lock", url: "/products/core/stama-b16-camera.webp" },
  { label: "Pro TFS BLE Shortlet Smart Lock", category: "lock", url: "/products/core/stama-tf5-shortlet.webp" },
  { label: "Base G290 Frameless Glass Lock", category: "lock", url: "/products/core/stama-g290-glass.webp" },
  { label: "Base V80 Heavy-Duty Gate Lock", category: "lock", url: "/products/core/stama-v80-gate.webp" },
  { label: "KT14 Heavy-Duty IP67 Smart Padlock", category: "lock", url: "/products/core/stama-kt14-padlock.webp" },
  { label: "Smart Lock 7.4V Rechargeable Battery", category: "lock", url: "/products/core/stama-lock-battery.webp" },
  { label: "Smart Lock Remote Control Fob", category: "lock", url: "/products/core/stama-lock-remote.webp" },
  { label: "G2 Bluetooth-to-WiFi Gateway Hub", category: "lock", url: "/products/core/stama-lock-gateway.webp" },
  { label: "RFID Smart Keycard / Keyfob", category: "lock", url: "/products/core/stama-rfid-card.webp" },
  { label: "Centralized Hotel Management System", category: "lock", url: "/products/core/stama-hotel-system.webp" },
