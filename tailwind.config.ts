...
export default {
  darkMode: ["class"],
  content: ["./index.html", "./src/**/*.{ts,tsx}", "!./src/data/**"],
  prefix: "",
  theme: {
    container: {
      center: true,
    ...
    extend: {
      ...
      keyframes: {
        ...
        "float-slower": {
          ...
          "50%": { transform: "translate3d(6px,-8px,0) rotate(1.5deg)" },
        },
        "blob": {
      ...
      animation: {
        ...
        "scale-in": "scale-in 0.9s cubic-bezier(0.16, 1, 0.3, 1) forwards",
        ...
        "soft-rise": "soft-rise 1.1s cubic-bezier(0.16, 1, 0.3, 1) forwards",
        "ken-burns": "ken-burns 28s cubic-bezier(0.45, 0, 0.55, 1) infinite alternate",
